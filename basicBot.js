...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            skipPosition: 3,
            skipReasons: [
                ["theme", "Ši daina neatitinka temos. "],
                ["op", "Ši daina yra OP liste. "],
                ["history", "Šią daina nesenai grojo. "],
                ["mix", "Jūs leidote daina, kuri prieštarauja taisyklėm. "],
                ["sound", "Daina kurią jūs paleidote turi bloga garso efekta ir/arba video. "],
                ["nsfw", "Daina kurią paleidote yra NSFW. "],
                ["unavailable", "Šią daina draudžiama leisti". "]
            ],
            afkpositionCheck: 15,
